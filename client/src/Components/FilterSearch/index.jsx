...
import { exitFilters, filterBy, orderSort } from "../../Redux/Actions.js";
  ...
  return (
    <nav>
      <ul className={s.mainList}>
        <li>
          <label htmlFor={s["filterControl"]}><Button text={"Filter"}/></label>
        ...
        <li>
          <label htmlFor={s["orderControl"]}><Button text="Order"/></label>
